...
<%@ page import="com.smartplacement.servlet.AdminInterviewsServlet.Interview" %>
...
<head>
    ...
    <title>View Interviews - Smart Placement System</title>
                ...
                %>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="<%= interview.getMode().toLowerCase() %>">
                        ...
                        <td>
                            ...
                            <span class="status <%= interview.getStatus().toLowerCase() %>">
                        ...
                        <td>
                            ...
                            <a
                                href="admin-interview-details?id=<%= interview.getId() %>"
                                class="view-button">
